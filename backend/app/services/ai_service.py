...
def build_prompt(data: dict):
    ...
    personalization_guidance = data.get('personalization_guidance') or ''

    profile_section = f"\n- Personal profile context: {profile_context}\n" if profile_context else ''
    personalization_section = f"\n- Personalization guidance: {personalization_guidance}\n" if personalization_guidance else ''
...
- uses the profile context only when directly relevant to the topic
- never invents profession, skills, achievements, or claims
